...
module tb_vit_pl_golden_basic_common #(
    parameter string ROOT = "../02_fixed_point_export/exports/seed1234"
);
...
module tb_vit_pl_golden_basic_seed1234;
    tb_vit_pl_golden_basic_common #(.ROOT("../02_fixed_point_export/exports/seed1234")) run();
endmodule

module tb_vit_pl_golden_basic_seed2026;
    tb_vit_pl_golden_basic_common #(.ROOT("../02_fixed_point_export/exports/seed2026")) run();
endmodule
