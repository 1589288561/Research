`timescale 1ns/1ps
`include "../03_pl_golden_rtl/fixed_params.vh"

module tb_vit_pl_20_samples_common #(
    parameter string WEIGHT_ROOT = "../02_fixed_point_export/exports/seed1234",
    parameter string DATA_ROOT   = "../04_20_sample_test_vectors/seed1234/fixed"
);
...
module tb_vit_pl_20_samples_seed1234;
    tb_vit_pl_20_samples_common #(
        .WEIGHT_ROOT("../02_fixed_point_export/exports/seed1234"),
        .DATA_ROOT("../04_20_sample_test_vectors/seed1234/fixed")
    ) run();
endmodule

module tb_vit_pl_20_samples_seed2026;
    tb_vit_pl_20_samples_common #(
        .WEIGHT_ROOT("../02_fixed_point_export/exports/seed2026"),
        .DATA_ROOT("../04_20_sample_test_vectors/seed2026/fixed")
    ) run();
endmodule
